  ...
  useEffect(() => {
    const run = async () => {
      ...
      if (variants.length) {
        ...
        setSize(first.option1 || '');
        setMaterial(first.option2 || '');
      }
        ...
        <div className="self-start lg:sticky lg:top-24">
          <div className="bg-[#F2ECE6] rounded-sm overflow-hidden aspect-[4/5]">
            {currentImage ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-[#8D8D8D]">No image</div>
            )}
          </div>
